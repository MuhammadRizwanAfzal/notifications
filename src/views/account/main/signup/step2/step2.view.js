...
import Step2Styles from "./step2.style";
        ...
        <div className="formBox cnt">
          <div className="titleSection">
            <Typography variant="h2" className="mainHeading">
              Create Your Travel Business Account
            </Typography>
          ...
          <CustomTextField
            ...
            error={errors?.confirmPassword?.[0]?.message}
            onChange={handleChange}
            startAdornment={
              <ConfirmPasswordIcon
                viewBox="0 0 24 24"
          ...
          />
          {signUpErrors && (
            <CustomAlert type="failure" description={signUpErrors} />
          )}
          <Typography align="left">
            By clicking Sign up button I agree to 365sol{" "}
            <CustomButton
              variant="text"
              buttonType="success"
              style={{ padding: "7px 0 0 0", marginBottom: 10 }}
          ...
          {/* <div style={{ textAlign: 'left' }}>
            <CustomChceckbox label="Remember me" />
          </div> */}
